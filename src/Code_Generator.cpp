														...
														std::ofstream& files_out)
{
	...
	files_out	<< "\tuart.writeString(\"[IRQ] PC requested an interrupt.\\n\");"				<< std::endl;
	files_out	<< "}"																			<< std::endl << std::endl << std::endl;
	files_out	<< "void intr_TBE		(unsigned int intr_addr)"								<< std::endl;
	files_out	<< "{"																			<< std::endl;
	files_out	<< "\tuart.writeString(\"[IRQ] TBE requested an interrupt.\\n\");"				<< std::endl;
	files_out	<< "}"																			<< std::endl << std::endl << std::endl;
	files_out	<< "void intr_RBF		(unsigned int intr_addr)"								<< std::endl;
	files_out	<< "{"																			<< std::endl;
	files_out	<< "\tuart.writeString(\"[IRQ] RBF requested an interrupt.\\n\");"				<< std::endl;
	//files_out	<< "\tRecieve_Buffer_Full_interrupt_handler();"									<< std::endl;
	files_out	<< "}"																			<< std::endl << std::endl << std::endl;
	files_out	<< "void intr_TXD		(unsigned int intr_addr)"								<< std::endl;
	files_out	<< "{"																			<< std::endl;
	files_out	<< "\tuart.writeString(\"[IRQ] TXD requested an interrupt.\\n\");"				<< std::endl;
	files_out	<< "}"																			<< std::endl << std::endl << std::endl;
	files_out	<< "void intr_RXD		(unsigned int intr_addr)"								<< std::endl;
	files_out	<< "{"																			<< std::endl;
	files_out	<< "\tuart.writeString(\"[IRQ] RXD requested an interrupt.\\n\");"				<< std::endl;
	files_out	<< "}"																			<< std::endl << std::endl << std::endl;
	files_out	<< "void intr_Timer		(unsigned int intr_addr)"								<< std::endl;
	files_out	<< "{"																			<< std::endl;
	...
	files_out	<< "\tuart.writeString(\"[IRQ] TIMER \%u requested an interrupt.\\n\", which);"	<< std::endl;
	...
	files_out	<< "\tuart.writeString(\"[IRQ] MPDR \%u requested an interrupt.\\n\", which);"	<< std::endl;
	...
	files_out	<< "\tunsigned int which = intr_addr & 0xF;"									<< std::endl;
	files_out	<< "\tuart.writeString(\"[IRQ] DMA \%u requested an interrupt.\\n\", which);"	<< std::endl;
	...
	files_out	<< "\tuart.writeString(\"[IRQ] Plane 0,";
	...
	files_out	<< "\tuart.writeString(\"[IRQ] Plane 1,";
	files_out	<< " PE \%u requested an interrupt.\\n\", which);"								<< std::endl;
	files_out	<< "}"																			<< std::endl << std::endl << std::endl;
	files_out	<< "void intr_PLANE_2	(unsigned int intr_addr)"								<< std::endl;
	files_out	<< "{"																			<< std::endl;
	...
	files_out	<< "\tuart.writeString(\"[IRQ] Plane 2,";
	files_out	<< " PE \%u requested an interrupt.\\n\", which);"								<< std::endl;
	files_out	<< "}"																			<< std::endl << std::endl << std::endl;
	files_out	<< "void intr_PLANE_3	(unsigned int intr_addr)"								<< std::endl;
	files_out	<< "{"																			<< std::endl;
	...
	files_out	<< "\tuart.writeString(\"[IRQ] Plane 3,";
	files_out	<< " PE \%u requested an interrupt.\\n\", which);"								<< std::endl;
	files_out	<< "}"																			<< std::endl << std::endl << std::endl;
														...
														std::vector<std::vector<size_t>> All_BLs)
{
	...
	Data_H_file << std::dec;
	Data_H_file << std::setfill(' ') << std::left	<< std::setw(28) << "const void*";
	Data_H_file << std::setfill(' ') << std::right	<< std::setw(32) << "MPDR_base_addr_ptr_lvl_";
	Data_H_file << std::setfill(' ') << std::left	<< std::setw(28) << embedd_array(lvl, All_BLs.size()) << "\t=\t" << std::endl;
	Data_H_file << "\t\t\t{"	<< std::endl	<< "\t\t\t\t\t";
	for (size_t bl = 0; bl < All_BLs.size(); bl++)
